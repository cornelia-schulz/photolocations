  ...
  return knex('locations').del()
    .then(function () {
      ...
      return knex('locations').insert([
        ...
        {id: 12, title: 'Jack\'s Lighthouse', label: '', lat: -443051, lng: 171261126, info_title: 'Great for city shots', info: ''},
        {id: 13, title: 'Tangermuende Gate', label: '', lat: 52.599832, lng: 11864420, info_title: 'Great for city shots', info: ''},
        ...
        {id: 22, title: 'Peter\'s Lookout', label: '', lat: -44088736, lng: 170.132834, info_title: 'Great for city shots', info: 'Great views towards Mt Cook'},
