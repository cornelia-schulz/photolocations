  ...
  return knex('photos').del()
    .then(function () {
      ...
      return knex('photos').insert([
        ...
        {id: 24, location_id: 15, title: 'Tangermuende', url: 'https://farm2.staticflickr.com/1827/42473239484_bd76d9c490_b.jpg'},
        {id: 25, location_id: 14, title: 'Uenglinger Tor', url: 'https://farm2.staticflickr.com/1785/42286982755_489ab5020c_b.jpg'},
        {id: 26, location_id: 16, title: 'Pulverturm', url: 'https://farm2.staticflickr.com/1803/41380901020_3e92a84d2c_b.jpg'},
